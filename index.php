    ...
    <div class="form-container">
        <form action="process.php" method="POST" class="auth-form">
            <div class="form-group">
                ...
                <small class="hint">Логин должен быть от 3 до 20 символов (буквы, цифры, _)</small>
            </div>

            <div class="form-group">
                <label for="password">Пароль:</label>
                <input type="password" id="password" name="password" required placeholder="Введите ваш пароль">
                <small class="hint">Пароль должен быть минимум 6 символов</small>
            </div>
        ...
        if (isset($_GET['error'])) {
            ...
            echo '<h3>Обнаружены ошибки:</h3><ul>';
        ...
        if (isset($_GET['success'])) {
            ...
            echo '<h3>Успешно!</h3><p>' . $success . '</p>';
            echo '</div>';
        }
        ?>
    </div>
